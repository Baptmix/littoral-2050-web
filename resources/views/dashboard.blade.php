...
@section('content')
    ...
    <main>
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <!-- https://tailwindtoolbox.github.io/Admin-Template/ -->
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h2 class="font-bold uppercase text-gray-600">Électeurs</h2>
                                <p class="font-bold text-3xl">{{$count_electors}}<span class="text-green-500"><i
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h2 class="font-bold uppercase text-gray-600">Utilisateurs Littoral 2050</h2>
                                <p class="font-bold text-3xl">{{$count_users}}<span class="text-yellow-600"><i
                                            class="fas fa-caret-up"></i></span></p>
                            </div>
                        </div>
                    </div>
