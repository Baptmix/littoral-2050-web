        ...
        <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 h-screen">
            <div class="max-w-md w-full space-y-8">
                <div>
                    ...
                    <h3 class="text-center text-xl text-gray-900">Définition du nouveau mot de passe</h3>
                </div>
                <form class="mt-8 space-y-6" action="{{route("reset_password_post")}}" method="POST">
